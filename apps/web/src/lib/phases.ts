...
export const PHASES = [
  ...
  { n: 6,  name: "Entrada do projeto na Celesc" },
  { n: 7,  name: "Projeto em análise" },
  { n: 8,  name: "Projeto aprovado" },
...
export const PHASE_DESCRIPTIONS: Record<number, string> = {
  ...
  6: "Documentação enviada para a Celesc abrir a análise do seu projeto.",
  7: "A Celesc está avaliando o projeto técnico. Este passo costuma ser o mais demorado.",
  8: "A Celesc aprovou o projeto. Liberado pra concluir a instalação.",
